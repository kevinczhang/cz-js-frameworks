...
## Intercept input property changes with a setter   <a href="#intercept-input-property-changes-with-a-setter" id="intercept-input-property-changes-with-a-setter"></a>
